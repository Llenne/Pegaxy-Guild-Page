                            ...
                            <>
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'stretch' }}>
                                    <Grid container spacing={2}>
                                        <Grid item md={6}>
                                            <Card variant="outlined" sx={{p: 4, backgroundColor:'transparent', mb: 2}}>
                                                <Stack spacing={3}>
                                                    <TextField fullWidth label={'Guild Name'}></TextField>
                                        ...
                                        <Grid item md={6}>
                                            <Card variant="outlined" sx={{display: 'flex',flexDirection: 'column', justifyContent: 'center', alignItems: 'center', p: 4, backgroundColor:'transparent'}}>
